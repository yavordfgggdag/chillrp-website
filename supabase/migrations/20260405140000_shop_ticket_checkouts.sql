-- Магазин: код за тикет в Discord → staff изпраща линк за плащане → маркиране „платено“ в админ.
-- Идемпотентно с RUN_THIS_shop_ticket_checkouts.sql
...
COMMENT ON TABLE public.shop_ticket_checkouts IS
  'Поръчка с код за Discord тикет; staff маркира paid след ръчно плащане.';
