-- Създава таблиците за модула Сервиз: service_invoices (Фактури) и service_shifts (Работно време).
-- Как да стартираш: Supabase Dashboard → твоя проект → SQL Editor → New query →
-- копирай целия файл, paste, Run. След това в Table Editor трябва да виждаш service_invoices и service_shifts.

-- ========== Service invoices (Фактури) ==========
